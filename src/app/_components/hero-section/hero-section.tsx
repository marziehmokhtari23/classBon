    ...
    return(
        ...
        <div className="container flex flex-col  items-center xl:flex xl:flex-row-reverse">
          ...
          <div className="flex-1 flex flex-col gap-5 mt-12 pb-5 text-center xl:text-right">
            ...
            <h1 className="leading-10 text-3xl lg:text-3xl xl:text-3xl mb-10 xl:leading-10 gradient">مسیر صعود به قله‌هابی برنامه نویسی</h1>
            <h4 className="max-w-2xl  text-lg md:text-xl font-bold leading-8">هر جای مسیر برنامه‌نویسی که باشی با همراهی اساتید باتجربه کلاسبن میتونی بدون محدودیت به قله‌های بالاتر صعود کنی ما همیشه هواتو داریم.</h4>
