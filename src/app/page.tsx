...
import { BlogPosList } from "./(blog)/_components/blog-post-card-list";
...
async function getNewestBlogs(count:number):Promise<BlogPostSummery[]> {
...
export default async function Home() {
    ...
    const newestBlogsData= getNewestBlogs(6)
    const [newestCourses,newestBlogs]=await Promise.all([newestCoursesData,newestBlogsData])
    ...
    return (
        <>
            ...
            <section className="container py-20">
                <div className="flex flex-col xl:flex-row gap-4 justify-center xl:justify-between items-center">
                    <div className="text-center xl:text-right">
                        ...
                        <p className="mt-3 text-lg">
                            ...
                            اختیارت می‌‌گذاریم؛ چون پیشرفتت برامون مهمه!
                        </p>
                    </div>
                    <Button
                        variant="neutral"
                ...
                <BlogPosList blogPostList={newestBlogs} />
            </section>
        </>
    );
}
